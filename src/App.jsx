...
const App = () => {
  ...
  return (
    <div className="relative flex">
      <Sidebar />
      <div className="flex-1 flex flex-col bg-gradient-to-br from-yellow-300 to-[#121286]">
        <Searchbar />
      ...
      {activeSong?.title && !playerOn && (
        ...
        >
          <div className="flex flex-col justify-center items-center animate-bounce pt-2 text-white font-semibold">
